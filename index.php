...
<html lang="ru">
    <head>
        ...
        renderMetatags(array(
            ...
            'description' => 'Производство натуральных фруктовых батончиков и пастилы из сухофруктов. Абрикосовые, сливовые и черносливовые батончики с орехами. Здоровое питание для активной жизни.',
            'keywords' => 'фруктовые батончики, пастила из сухофруктов, натуральные батончики, батончики, абрикосовая пастила, батончики с орехами, здоровое питание, НЕО-ФРУТ, неофрут',
            'canonical' => 'https://neo-fruit.ru/',
            'og_url' => 'https://neo-fruit.ru/',
            'og_title' => 'НЕО-ФРУТ - Натуральные фруктовые батончики и пастила',
            'og_description' => 'Производство натуральных фруктовых батончиков и пастилы из сухофруктов. Здоровое питание для активной жизни.',
            'twitter_url' => 'https://neo-fruit.ru/',
            'twitter_title' => 'НЕО-ФРУТ - Натуральные фруктовые батончики и пастила',
            'twitter_description' => 'Производство натуральных фруктовых батончиков и пастилы из сухофруктов.',
        ...
        <script type="application/ld+json">
        {
            ...
            "description": "Производство натуральных фруктовых батончиков и пастилы из сухофруктов",
            "address": {
                "@type": "PostalAddress",
                "addressCountry": "RU",
